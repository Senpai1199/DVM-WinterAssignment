...
urlpatterns = [
	...
	path('personal-feed/', views.personal_feed, name='personal-feed'),
	path('follow-user/', views.follow_user, name='follow-user'),
	path('unfollow-user/', views.unfollow_user, name='unfollow-user'),
	path('subscribe/', views.subscribe_to_user, name='subscribe'),
	path('unsubscribe/', views.unsubscribe_to_user, name='unsubscribe'),
]